...
public class panel extends JPanel implements ActionListener { //its a special type of class
    ...
    public void spawnfood(){
        foodx = random.nextInt( width/unit)*unit; //600/50*50
        foody = random.nextInt( height/unit)*unit;//50/50
    }
    ...
    public void draw(Graphics graphic){
        if (flag == true){
            graphic.setColor(Color.RED); //snake food color
            graphic.fillOval(foodx,foody,unit,unit); //snake food shape
           ...
           graphic.setColor(Color.blue) ; //score design
